<div class="mx-auto px-4 py-8">
    <section class="mb-">
        <!-- Judul -->
        <h2 class="text-4xl font-bold text-center mb-12 text-text-light dark:text-text-dark">Most Popular Posts</h2>
        ...
        <div class="w-full mx-auto py-4">
            <div class="relative overflow-hidden">
                                ...
                                <div class="bg-white dark:bg-gray-800 rounded-lg overflow-hidden">
                                    ...
                                    <div class="p-6">
                                        ...
                                        <a href="{{ route('post.show', $post->slug) }}">
                                            <h3 class="text-lg font-bold mt-2 text-text-light dark:text-text-dark">
                                                {{ $post->title }}
                                            </h3>
                                        </a>
                ...
                <div class="flex justify-center items-center mt-2 space-x-4">
                    <button id="prevBtn"
                        class="text-subtext-light dark:text-subtext-dark text-sm hover:text-green-500 transition-colors disabled:opacity-50 disabled:cursor-not-allowed">
                        Prev
                    </button>
                ...
                for (let i = 0; i < indicators.length; i++) {
                    if (i === this.currentSlide) {
                        ...
                        indicators[i].className =
                            'h-2 w-2 rounded-full bg-green-300 dark:bg-gray-600 transition-colors';
                    }
                }
            }
